...
#define USB_CDC_CMDIF_CIF_NUM   0
#define USB_CDC_CMDIF_DIF_NUM   1
#define USB_CDC_CMDIF_EP_INT_IN    USB_ENDPOINT_IN(1)
#define USB_CDC_CMDIF_EP_BULK_IN   USB_ENDPOINT_IN(2)
#define USB_CDC_CMDIF_EP_BULK_OUT  USB_ENDPOINT_OUT(2)
